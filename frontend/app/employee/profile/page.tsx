...
export default function EmployeeProfilePage() {
  ...
  return (
    <section className="pb-24">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-2 text-[var(--text-secondary)]">
            Your CRM profile, targets, and current pipeline performance.
          </p>
        </div>
        <button
      ...
      {error && (
        <div className="mb-6 rounded-2xl bg-red-500/10 p-4 text-red-600">
          {error}
        </div>
      )}
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            <Info
              ...
              value={`${employee?.monthlyTarget || 0} deals`}
            />
          </div>
        </div>
...
function Metric({
  ...
  return (
    <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-5">
      <div className="mb-4 grid h-10 w-10 place-items-center rounded-xl bg-[var(--primary)]/10 text-[var(--primary)]">
        {icon}
      </div>
